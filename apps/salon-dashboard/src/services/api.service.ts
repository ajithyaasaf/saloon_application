...
class BrowserTokenStorage implements ITokenStorage {
  ...
  getAccessToken(): string | null {
    if (typeof window !== 'undefined') {
      return localStorage.getItem('saloon_access_token');
    }
  ...
  setAccessToken(token: string | null): void {
    if (typeof window !== 'undefined') {
      if (token) {
        localStorage.setItem('saloon_access_token', token);
      } else {
        localStorage.removeItem('saloon_access_token');
      }
    }
  ...
  getRefreshToken(): string | null {
    if (typeof window !== 'undefined') {
      return localStorage.getItem('saloon_refresh_token');
    }
  ...
  setRefreshToken(token: string | null): void {
    if (typeof window !== 'undefined') {
      if (token) {
        localStorage.setItem('saloon_refresh_token', token);
      } else {
        localStorage.removeItem('saloon_refresh_token');
      }
    }
  ...
  clearTokens(): void {
    if (typeof window !== 'undefined') {
      localStorage.removeItem('saloon_access_token');
      localStorage.removeItem('saloon_refresh_token');
      localStorage.removeItem('saloon_user_session');
    }
